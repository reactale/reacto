---
title: Cheatsheet
description: This cheatsheet provides a brief overall glance on all the capabilities of Reactos.
...
- `((r.cfg.langSwitch.LLL))` Changes the language of Reactos to LLL (language short code, e.g. *en* for *English*, *bn* for *Bengali* etc). For all possible language codes, [visit the playground](/playground)
